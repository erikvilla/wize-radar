  ...
  mapActions () {
    ...
    axios.all([
         ...
         .then(axios.spread((res1, res2, res3) => {
             ...
             const attr = {
               ...
               teams: _.map(availableTeams, (singleTeam) => {
                 return {
                   ...
                   sentiments: _.map(singleTeam.checkpoints, (checkpoint) => checkpoint.attributes[selectedAttribute.id].sentiment)
                                .reverse(),
                   health: _.map(singleTeam.checkpoints, (checkpoint) => checkpoint.attributes[selectedAttribute.id].rating)
                            .reverse(),
                 }
               })
             }
           ...
           this.setState({attributes: newStateAttributes, loading: false})
         }))
  }
        ...
        <Segment basic loading={loading}>
          <Segment.Group>
            ...
            <Segment textAlign='center' style={{backgroundColor: '#f2f3f7'}}>
              <Button size='huge' color='blue' as='a' href='/compare'>
